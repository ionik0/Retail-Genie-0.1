<<<<<<< HEAD
// AI Message Generation Service - Uses Hugging Face powered FastAPI
...
exports.generateAIResponse = async (userMessage, context = "") => {
    try {
        ...
        const res = await axios.post(`${RECOMMENDER_URL}/generate-message`, payload, {
            timeout: 15000,
            headers: {
        ...
        if (res.status === 200 && res.data.response) {
            console.log('[AI Service] Response generated:', res.data.response);
            console.log('[AI Service] Model used:', res.data.model);
        ...
        console.error('[AI Service ERROR]', {
            ...
            endpoint: `${RECOMMENDER_URL}/generate-message`,
        });
